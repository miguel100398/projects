...
public class Combinadas extends JFrame implements ActionListener{
	...
	public Combinadas(Mate mate, JuegoCombinadas juegoCombinadas, Juego gm){
		super();
		...
		Titulos lbTitulo= new Titulos(Color.BLUE, "Combinadas", "Tahoma", 60);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==this.btNivelUno){
			this.gm.setNivel(1);
			this.gm.setJuego("Operaciones combinadas");
			this.juegoCombinadas.setNivel(1);
			this.gm.reset();
			...
			this.gm.setNivel(2);
			this.gm.setJuego("Operaciones combinadas");
			this.juegoCombinadas.setNivel(2);
			this.gm.reset();
			this.gm.activarBotones();
			this.gm.setVisible(true);
			this.gm.start();
			...
			this.gm.setNivel(3);
			this.gm.setJuego("Operaciones combinadas");
			this.juegoCombinadas.setNivel(3);
			this.gm.reset();
			this.gm.activarBotones();
			this.gm.setVisible(true);
			this.gm.start();
			...
			this.gm.setNivel(4);
			this.gm.setJuego("Operaciones combinadas");
			this.juegoCombinadas.setNivel(4);
			this.gm.reset();
			this.gm.activarBotones();
			this.gm.setVisible(true);
			this.gm.start();
			...
			this.gm.setNivel(5);
			this.gm.setJuego("Operaciones combinadas");
			this.juegoCombinadas.setNivel(5);
			this.gm.reset();
			this.gm.activarBotones();
			this.gm.setVisible(true);
			this.gm.start();
